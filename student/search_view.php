...
<div class="row">
    ...
    <button type="submit" name="apply" class="btn btn-success" style="float:right; margin-left: 10px;">Apply</button>

    <a class="btn btn-primary" href="search.php" role="button" style="float:right;">Back</a>
